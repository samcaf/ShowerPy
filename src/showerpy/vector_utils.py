...
class Vector:
    ...
    def contract(self, vector):
        """Performs a contraction between this vector
        and another vector.
        """
        return contract(self.vector, vector.vector)
    ...
    def angle(self, vector):
        ...
        vector.
        """
        return math.acos(self.unit().contract(vector.unit()))
    ...
    def rand_perp_vector(self):
        """Returns a random vector perpendicular to this vector.
        """
        return rand_perp_vector(self)


    def split(self, z, theta):
        """Splits the vector into two vectors with magnitudes
...
class FourVector(Vector):
    ...
    def y(self):
        ...
        assert (self.vector[3]/self.vector[0])**2 < 1, \
            "Rapidity is only defined for timelike vectors."
